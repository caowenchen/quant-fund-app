...
本项目是我在探索AI辅助开发过程中，通过**人机协作模式**完成的学习项目。

### 开发工作流
1. **需求定义**：我独立设计系统架构、功能模块与数据流
2. **Prompt Engineering**：使用GPT优化需求表达，提升提示词的结构化和精确度
3. **AI代码生成**：通过优化后的提示词驱动DeepSeek-V4-Pro逐模块生成代码
4. **人工审查与验收**：我对生成的代码进行逻辑验证、边界测试和错误修正，独立完成部署

### 我的收获
- 理解了Prompt Engineering对代码生成质量的显著影响
- 掌握了"定义问题→拆解需求→验证结果"的AI协作开发范式
- 验证了AI工具在全栈复杂工程场景中的落地可行性

&gt; ⚠️ **声明**：本项目为个人技术学习项目，不构成任何投资建议。
